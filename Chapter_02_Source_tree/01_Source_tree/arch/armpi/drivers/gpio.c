...
void arch_set_gpio_pin_for_write(unsigned int gpio_pin)
{
...
void arch_turn_gpio_pin_on(unsigned int gpio_pin)
{
...
void arch_turn_gpio_pin_off(unsigned int gpio_pin)
{
